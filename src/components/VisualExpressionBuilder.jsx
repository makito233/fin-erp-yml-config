...
const CONCEPTS = [
  { id: 'input', label: 'Input Field', icon: CubeIcon, template: '#input.' },
  { id: 'invoicingItems', label: 'Invoicing Item (Select)', icon: ListBulletIcon, template: null, isSelector: true },
  { id: 'orderMetadata', label: 'Order Metadata', icon: CubeIcon, template: '#input.orderMetadata.' },
  { id: 'handlingStrategy', label: 'Handling Strategy', icon: FunnelIcon, template: '#input.orderMetadata.handlingStrategy' },
  { id: 'variable', label: 'Variable', icon: CubeIcon, template: '#' },
]

const OPERATIONS = [
  { id: 'add', label: 'Add (+)', icon: PlusIcon, template: ' + ' },
  { id: 'subtract', label: 'Subtract (-)', icon: CalculatorIcon, template: ' - ' },
  { id: 'multiply', label: 'Multiply (*)', icon: CalculatorIcon, template: ' * ' },
  { id: 'divide', label: 'Divide (/)', icon: CalculatorIcon, template: ' / ' },
  { id: 'ternary', label: 'Condition (?:)', icon: QuestionMarkCircleIcon, template: ' ? : ' },
  { id: 'elvis', label: 'Elvis Operator (?:)', icon: QuestionMarkCircleIcon, template: ' ?: ' },
  { id: 'nullSafe', label: 'Null Safe (?.)', icon: QuestionMarkCircleIcon, template: '?.' },
  { id: 'mapLookup', label: 'Map Lookup', icon: ListBulletIcon, template: "{ '': }[]" },
  { id: 'parentheses', label: 'Grouping ()', icon: CalculatorIcon, template: '()' },
  { id: 'toString', label: 'To String', icon: CodeBracketIcon, template: '.toString()' },
  { id: 'toLowerCase', label: 'To Lower', icon: CodeBracketIcon, template: '.toLowerCase()' },
  { id: 'toUpperCase', label: 'To Upper', icon: CodeBracketIcon, template: '.toUpperCase()' },
]
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
        <div className="text-xs font-medium text-gray-500 mb-1">Current Expression:</div>
